...
fileName = 'N40-UFLP-LowScaleResult.txt';
...
for Function_No = problem_start:problem_stop
    ...
    for i=1:1:30
        o=5;
        gapoBABC = mean(Function{Function_No}.MinIter(o,:));
        o=6;
        gapPBABC = mean(Function{Function_No}.MinIter(o,:));
        o=1;
        gapDABC = mean(Function{Function_No}.MinIter(o,:));
        o=2;
        gapABCbin = mean(Function{Function_No}.MinIter(o,:));
        o=3;
        gapbinABC = mean(Function{Function_No}.MinIter(o,:));
        o=4;
        gapbitABC = mean(Function{Function_No}.MinIter(o,:));
