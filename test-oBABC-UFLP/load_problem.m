...
for Function_No=1:15
    ...
    fn(Function_No)=2^(matris.numOfFactories*matris.numOfCustomers)/p1*2.5;
    fprintf("%s warehouse %d, customer %d cal%.2f.\r\n",Function_Name,matris.numOfFactories,matris.numOfCustomers,fn(Function_No));
end
