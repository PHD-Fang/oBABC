function [minIter,notUpdateTimes,GAP, Convergence , Best_Obj , Best_Fit ,Best_Sol] = ZABC(Function_Name, initPos, opCode)
...
while FuncEval < Parameters.MaxFuncEval
    ...
    Parameters.q =  Parameters.qStart - (Parameters.qStart -  Parameters.qEnd)*(Parameters.t/Parameters.maxIter);
%     [Parameters.dim, Parameters.q]
    for i=1:NB
        ...
        [opCode,NewSolution.Solution] = ApplyNeighborhood(i,neighbor,opCode);
